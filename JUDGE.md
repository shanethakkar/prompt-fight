...
- **`item`** (self, P3.2) — equip one of your units (`target_id`). `name` + for a weapon `element`+`power` ((re)arms the unit), or for armor/a trinket `tags` (e.g. `["kryptonite"]`). "Give my orc a flaming sword", "forge kryptonite armor".
