...
- **Aptitude (competence)** — *is the actor fit to do this?* Judged and server-grounded into `fit`/`improvised`/`unfit`; sets the base reliability and a power multiplier. **P1.1 stubs this to `fit`; P1.2 grounds it** (a stickman's fireball vs a mage's — see the changelog).
